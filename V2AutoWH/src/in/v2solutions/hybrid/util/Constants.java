...
public class Constants {
	...
	public static String masterorPath = "/src/in/v2solutions/hybrid/masteror/";
	...
	public static int SMALL_WAIT = 2000;
	...
	public static WebElement returnElementIfPresent(String ObjectIdentifier) {
		...
		try {
			...
			case "id":
				...
				break;
			case "cssSelector":
				element = driver.findElement(By.cssSelector(objectIdentifierValue));
				Thread.sleep(250);
				break;
			case "linkText":
			...
			case "xpath":
				...
				break;
			case "class":
				element = wait.until(ExpectedConditions.visibilityOfElementLocated(By.className(objectIdentifierValue)));
				Thread.sleep(250);
				break;	
			case "name":
	...
	public static List<WebElement> returnElementsIfPresent(String ObjectIdentifier) {
		...
		try {
			...
			case "xpath":
				...
				break;
			case "class":
				lsElements = driver.findElements(By.className(objectIdentifierValue));
				Thread.sleep(250);
				break;	
			case "name":
				lsElements = driver.findElements(By.name(objectIdentifierValue));
				Thread.sleep(250);
				break;
			default:
				System.out.println("RESULT: FAIL - Please check your identifier Type in OR file  for => " + ObjectIdentifier);
